...
% Specify dataDir as the desired location of the dat
dataDir = tempdir;
...
% Create a randomPatchExtractionDatastore (Image Processing Toolbox) that performs randomized patch extraction from the upsampled and residual image datastores.
...
% Observe the activations from the final layer (a regression layer).
...
% Convert the image to the RGB color space by using the ycbcr2rgb (Image Processing Toolbox) function.
