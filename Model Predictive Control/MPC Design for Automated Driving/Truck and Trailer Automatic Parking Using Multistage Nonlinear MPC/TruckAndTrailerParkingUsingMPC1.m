...
% The initial position must be valid.
% Use the inequality constraint function TruckTrailerIneqConFcn to check for validity.
...
% Two plots are generated. One is the animation of the parking process, where blue circles indicate the optimal path and the initial guess is shown as a dot.
