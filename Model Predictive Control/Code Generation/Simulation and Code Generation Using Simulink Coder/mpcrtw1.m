...
% This example shows how to simulate and generate real-time code for an MPC Controller block with Simulink(R) Coder(TM).
...
% On a Windows(R) system, an executable file named mpc_rtwdemo.exe appears in the temporary directory after the build process finishes.
