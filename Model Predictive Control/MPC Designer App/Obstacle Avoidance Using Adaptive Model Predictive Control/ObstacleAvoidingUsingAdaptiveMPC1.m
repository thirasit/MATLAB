...
%%% Vehicle Model
% The ego car has a rectangular shape with a length of 5 meters and width of 2 meters.
...
figure
imshow("ObstacleAvoidingUsingAdaptiveMPCExample_eq16362404699335716406.png")
axis off;
...
figure
imshow("ObstacleAvoidingUsingAdaptiveMPCExample_eq07304365913900073195.png")
axis off;
