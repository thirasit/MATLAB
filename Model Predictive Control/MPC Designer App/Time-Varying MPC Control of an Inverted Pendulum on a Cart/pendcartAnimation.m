function pendcartAnimation(block, varargin)
...
function LocalPendInit(RefBlock)
    ...
    Fig = figure(...
      ...
      'Resize',          'off',...
      'DeleteFcn',       'pendcartAnimation([],[],[],''DeleteFigure'')',...
      'CloseRequestFcn', 'pendcartAnimation([],[],[],''Close'');');
    AxesH = axes(...
      'Parent',  Fig,...
      'Units',   'pixel',...
    ...
    SlideControl = uicontrol(...
      ...
      'Max',      9,...
      'Value',    RefSignal,...
      'Callback', 'pendcartAnimation([],[],[],''Slider'');');
    uicontrol(...
      'Parent',  Fig,...
      'Style',   'pushbutton',...
      'Position',[415 15 70 20],...
      'String',  'Close', ...
      'Callback','pendcartAnimation([],[],[],''Close'');');
