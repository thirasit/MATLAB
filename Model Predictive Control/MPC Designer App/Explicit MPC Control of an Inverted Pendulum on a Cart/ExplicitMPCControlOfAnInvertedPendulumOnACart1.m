...
figure
imshow("ExplicitMPCControlOfAnInvertedPendulumOnACartExample_01.png")
axis off;
...
figure
imshow("ExplicitMPCControlOfAnInvertedPendulumOnACartExample_02.png")
axis off;
...
% The plant has two inputs, dF and F, and two outputs, x and theta. In this example, dF is specified as an unmeasured disturbance used by the MPC controller for better disturbance rejection. 
...
figure
imshow("ExplicitMPCControlOfAnInvertedPendulumOnACartExample_03.png")
axis off;

figure
imshow("ExplicitMPCControlOfAnInvertedPendulumOnACartExample_04.png")
axis off;
