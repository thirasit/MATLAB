...
% This example provides the Simulink model slexNLPClassificationLinearPredictExample.slx, which includes the ClassificationLinear Predict block. You can open the Simulink model or create a new model as described in this section.
