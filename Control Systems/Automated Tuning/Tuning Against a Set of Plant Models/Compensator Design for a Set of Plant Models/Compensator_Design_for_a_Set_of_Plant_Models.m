...
% Typically, the dynamics of the plant, G, are not known exactly and can vary based on operating conditions. 
% For example, the system dynamics can vary:
...
figure
imshow("xxMultiModelPlantDemoFigures_02.png")
...
% To select the fifth model in the array as the nominal model, in the Multimodel Configuration dialog box, set the Nominal Model Index to 5. 
% The app response plots update automatically.
