...
% This example shows how to use Control System Tuner to tune a control system when there are parameter variations in the plant. The control system used in this example is an active suspension of a quarter-car model. 
...
% Its inputs are road disturbance and the force for the active suspension. Its outputs are the suspension deflection and body acceleration. 
...
figure
imshow("ControlSystemTuner_ActiveSuspensionQuarterCarExample_01.png")
